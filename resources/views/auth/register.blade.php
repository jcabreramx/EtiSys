{{-- <div class="modal fade" id="mod_Register" data-backdrop="static" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-gray" id="headerRegister">
                <h4 class="modal-title" id="titleRegister" style="margin-top: -13px">Nuevo Usuario</h4>
                <button type="button" class="close bg-gray btn" data-dismiss="modal" aria-label="Close" onclick="closeMRegister()">
