                ...
                {{-- <div class="row mb-1">
                    ...
                    <div class="tab-content" id="div_usuarios">
                        ...
                        <div class="tab-pane fade" id="departamentos" role="tabpanel" aria-labelledby="departamentos-tab">
                            ...
                            <div class="box_tooltip">
                                <button class="box btn_round_dep flecha_down" alt="NUEVO DEPARTAMENTO" id="btnNuevoDepartamento"
                        ...
                        <div class="tab-pane fade" id="puestos" role="tabpanel" aria-labelledby="puestos-tab">
                            ...
                            <div class="box_tooltip">
                                <button class="box btn_round_pue flecha_down" alt="NUEVO PUESTO" id="btnNuevoPuesto"
                                    onclick="nuevoPuesto()" type="button">
                                    <i class="fas fa-plus-circle"></i>
                                </button>
                            </div>
                            <div id="puestosDiv">
                        ...
                        <div class="tab-pane fade" id="perfiles" role="tabpanel" aria-labelledby="perfiles-tab">
                            ...
                            <div class="box_tooltip">
                                <button class="box btn_round_per flecha_down" alt="NUEVO PERFIL" id="btnNuevoPerfil"
                                    onclick="nuevoPerfil()" type="button">
                                    <i class="fas fa-plus-circle"></i>
                                </button>
                            </div>
                            <div id="perfilesDiv">
